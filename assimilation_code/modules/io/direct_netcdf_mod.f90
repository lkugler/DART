...
integer(i8) :: start_pos, end_pos, var_size, start_point, elm_count

real(r8), allocatable :: var_block(:)

write(*,*) 'start read_single_file'
...
integer :: copies_read
integer(i8) :: num_state_variables
integer :: dummy_loop
